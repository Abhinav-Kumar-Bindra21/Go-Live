  ...
  if (participants.length === 0) {
    return (
      <div className="h-full flex flex-col items-center justify-center text-slate-400 text-sm py-12">
        <UserIcon className="size-8 mb-2 text-slate-300" />
        ...
        return (
          ...
          >
            <div className="flex items-center gap-3">
              <div className="size-9 rounded-full bg-cyan-50 border border-cyan-200 text-primary font-bold flex items-center justify-center text-sm">
              ...
              <div>
                <span className="text-sm font-semibold text-slate-800 flex items-center gap-1.5">
                  {p.name}
                  {isHost && <CrownIcon className="size-3.5 text-emerald-500" title="Host" />}
                </span>
