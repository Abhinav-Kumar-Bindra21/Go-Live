...
const SessionsCard = ({ session, onOpenDetails, onRejoin }) => {
  ...
  return (
    <div className="bg-white/70 backdrop-blur-2xl rounded-3xl p-6 transition-all flex flex-col justify-between space-y-5 border border-slate-100/60 shadow-xs">
      ...
      <div className="grid grid-cols-2 gap-3 pt-3 border-t border-slate-300/30">
        <div className="flex items-center gap-2 text-xs bg-slate-200/50 p-2.5 rounded-xl">
