...
const ChatPanel = ({ isOpen, onClose, message, onSendMessage, currentUser }: ChatProps) => {
    ...
    <aside className="w-full sm:w-80 h-full bg-white border border-slate-200 flex flex-col z-30 shadow-2xl animate-in slide-in-from-right duration-200">
      ...
      <form onSubmit={handleSubmit} className="p-3 border-t border-slate-200 bg-slate-50 flex items-center gap-2">
        <input
          ...
          className="flex-1 bg-white border border-primary/80 focus:border-primary rounded-xl px-3.5 py-2.5 text-sm text-slate-900 placeholder-slate-400 outline-none transition-all shadow-xs"
        />
