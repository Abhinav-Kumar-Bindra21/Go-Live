      ...
      <div className="flex items-center gap-3 mx-auto sm:mx-0">
        ...
        >
          ...
          {unreadCount > 0 && !isChatOpen && (
            <span className="absolute -top-1 -right-1 bg-primary text-white text-[10px] font-bold size-5 rounded-full flex items-center justify-center border-2 border-white shadow-xs">
              {unreadCount}
            </span>
          )}
        </button>
        ...
        >
          ...
          <span className="absolute -top-1 -right-1 bg-slate-200 text-slate-200 text-[10px] font-bold px-1.5 py-0.5 rounded-full  border border-slate-300 ">
            {participantCount}
          </span>
        </button>
